...
public class sendPluginMessage extends Plugin {
    ...
    public static void sendPlayerModIsActivate(ProxiedPlayer p, ArrayList<UUID> staffList, String serverName){
        ByteArrayDataOutput out = ByteStreams.newDataOutput();
        out.writeUTF("ModIsActivate");
        ...
        ProxyServer.getInstance().getServerInfo(serverName).sendData("ModIsActivate", out.toByteArray());
    }
